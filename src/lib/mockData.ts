...
Pick one corner — ideally a slow hairpin where mistakes are manageable. Spend 15 minutes doing nothing except trying to carry a small amount of brake past the turn-in. Don't worry about speed. Focus on feeling the weight on the front tires during entry. Once you feel it, you'll understand why every fast driver uses this.`,
  ...
  {
    id: 'l-trail-braking-advanced',
    slug: 'trail-braking-advanced',
    title: 'Trail Braking at the Limit',
    summary: 'Full mastery of trail braking — high-speed entries, rotation management, and the exact release profile that separates fast drivers from quick ones.',
    pillar: 'racing',
    category: 'braking',
    difficulty: 'advanced',
    keyTakeaways: [
      'The brake release curve is exponential, not linear — steep at first, barely-perceptible near the apex',
      'At high-speed entries, trail braking stabilizes the car by keeping weight on the nose through the arc',
      'Over-rotating on entry costs more time than under-rotating — err on the side of less rotation',
      'The moment you fully release brake is the moment understeer or push can develop — manage it with throttle timing',
      'Telemetry overlap of brake and steering traces is the diagnostic tool — they should converge smoothly',
    ],
    body: `Trail braking basics get covered in the intermediate lesson. This is about what happens when you push the technique to its actual limit — and more importantly, what the failure modes look like and how to fix them.\n\nThe brake release from the turn-in point to the apex is not a straight ramp down. The first portion of the release is fast — you're shedding the bulk of brake pressure quickly because most of your deceleration happens in the straight-line phase. But as you approach the apex, the release slows dramatically. You're holding just a few percent of brake pressure for the last portion of the entry arc, barely enough to feel. That final trace of braking keeps weight loaded on the front tires right when they need it most.\n\nAt high-speed corners, trail braking has a stability function that isn't present in slow corners. High-speed entry means the car is generating significant aerodynamic load. Releasing all brake before turn-in at these speeds causes the car to become "light" on the nose — the front rises slightly as weight transfers rearward. That's grip leaving the front tires exactly when you're asking them to generate cornering force. A small trail of brake prevents this transition, keeping the front planted.\n\nThe failure mode to study is over-rotation: too much brake pressure held too long combined with a tight turn-in creates a snap. The rear unloads under the combined braking and cornering demand and steps out faster than a catch is possible. The prevention is knowing what "enough rotation" feels like — the nose points to the apex without the rear threatening. Anything beyond that is not a performance gain.\n\nIf you're using telemetry, overlay your brake pressure trace over your steering angle trace. They should smoothly converge: steering increasing as brake decreases, crossing somewhere around the apex. If the brake trace ends abruptly while steering is still rising, you're releasing too early. If they're parallel for any length of time — both up simultaneously — you're carrying too much brake for too long into the corner.`,
    thumbnailColor: '#1A0A08',
    emoji: 'Gauge',
    conceptIds: ['c-trail-braking', 'c-grip-circle', 'c-snap-oversteer'],
    diagramIds: ['d-trail-braking'],
    quizId: 'q-trail-braking-advanced',
    relatedLessonIds: ['l-trail-braking-basics', 'l-threshold-braking', 'l-brake-release'],
    moduleId: 'mod-car-control',
...

  {
    id: 'l-corner-linking',
    slug: 'corner-linking',
    title: 'Linking Corners: When to Sacrifice Entry for Exit',
    summary: 'How to read corner sequences and deliberately compromise one corner to optimize the next — the skill that separates tactical drivers from lap-timers.',
    pillar: 'racing',
    category: 'cornering',
    difficulty: 'advanced',
    keyTakeaways: [
      'Any corner followed by a long straight is an exit-priority corner — sacrifice entry for maximum exit speed',
      'In a chicane or complex, the last element before the straight sets the whole sequence\'s value',
      'Entering a corner badly on purpose requires committing to the plan — hesitation gives you worst of both',
      'Straight-line speed compounds over distance; corner speed is spent instantly',
      'Learn which corners at each track are "throw-away" corners and which are "money" corners',
    ],
    body: `The slow-in-fast-out principle covers single corners. Corner linking is what happens when you have multiple corners in a sequence and a decision to make about which ones to optimize.\n\nThe core concept: every corner has a value. That value is determined almost entirely by what comes after it. A corner that feeds directly onto a long straight has enormous value — the exit speed you carry from that corner will be worth fractions of a second over the entire straight. A corner that leads into another corner, or into a slow section, has much less value. Understanding this hierarchy tells you where to invest your grip budget and where to accept a compromise.\n\nIn practice, this means deliberately entering a "setup corner" worse than you could. Say you have a left-hander immediately followed by a fast right onto the main straight. You could hit the left-hander perfectly — late apex, perfect exit — but doing so leaves you on the wrong side of the track with no room to set up for the right-hander. Instead, you clip the left-hander earlier, sacrifice a little exit speed, but arrive exactly where you need to be for the right-hander: wide, with room to late-apex onto the straight. The time you give up in the left-hander is smaller than the time you gain in the right.\n\nChicanes work the same way. The second element is always the priority. Thread through the first element to arrive in position for the second. Most drivers brake for the first element, which limits how cleanly they can get through the second. The fast approach is to brake for the second element, floating through the first as neutrally as possible.\n\nThe mental model: think of every complex as one combined corner with a single exit. All of your optimization should aim at that exit. The intermediate sections are just connecting geometry.`,
    thumbnailColor: '#080F15',
    emoji: 'Route',
    conceptIds: ['c-racing-line', 'c-apex', 'c-grip-circle'],
    diagramIds: ['d-chicane'],
    quizId: 'q-corner-linking',
    relatedLessonIds: ['l-apex-types', 'l-slow-in-fast-out', 'l-racing-line'],
    moduleId: 'mod-racing-line',
  ...
  {
    id: 'l-tire-management-racing',
    slug: 'tire-management-racing',
    title: 'Tire Management: Racing a Stint',
    summary: 'How to read tire deg in real time, adjust your driving style to extend a stint, and know when a tire is too far gone to save.',
    pillar: 'racing',
    category: 'racecraft',
    difficulty: 'advanced',
    keyTakeaways: [
      'Tire deg is not linear — tires can go from working to completely dead within a single lap',
      'Overheating is permanent within a stint; worn but cool tires often still have useful life',
      'Reduction in entry rotation is usually the first sign of rear degradation — the rear stops helping',
      'Sliding generates heat; saving tires means reducing slides, not reducing speed',
      'Know your car\'s specific tire sensitivity — some cars kill rears, others kill fronts; drive accordingly',
    ],
    body: `Tires degrade. That's a given. What's not obvious is how non-linear that degradation is, and how much a driver's technique influences the rate.\n\nThe first thing to understand is the difference between wear and thermal degradation. Wear is physical rubber loss — you can't undo it. Thermal degradation is damage done by excessive heat — and while a lap of overheating hurts, the heat can sometimes dissipate if you back off. This distinction matters because it changes your in-stint strategy. If you've thermally spiked the rears in laps three through six, coasting slightly in laps seven and eight might bring them back into window. If you've physically worn them through, nothing helps.\n\nThe main cause of tire death is sliding. Every time a tire slides — in understeer, oversteer, on entry, on exit — it's scrubbing rubber off the surface and generating heat simultaneously. The driver who manages tires well isn't necessarily slower; they're generating the same cornering forces with less sliding. Smooth inputs, earlier braking with later throttle, and precise line-following all reduce slide without reducing lap time as much as you'd expect.\n\nReading degradation in real time: the rear losing its willingness to rotate on entry is usually the first sign. The car starts to push on entry where it used to rotate cleanly. That's the rears going away — they're no longer contributing to rotation because they're past their grip peak. Later in the deg cycle, the car starts to push everywhere. When a tire is dead, the car feels like it has no front grip either — because the fronts are working overtime trying to compensate for the rears.\n\nKnow the characteristics of your specific car and compound. Some cars are brutal on rear tires and easy on fronts. Others destroy the outside fronts through aggressive camber demands. Knowing which end is your tire's weak point tells you which part of your driving to moderate first.`,
    thumbnailColor: '#0F0F0A',
    emoji: 'Gauge',
    conceptIds: ['c-heat-cycle', 'c-contact-patch', 'c-grip-circle'],
    diagramIds: [],
    quizId: 'q-tire-management-racing',
    relatedLessonIds: ['l-tire-temperature', 'l-tire-wear', 'l-consistency'],
    moduleId: 'mod-race-iq',
  ...
  {
    id: 'l-dirty-air-racing',
    slug: 'dirty-air-racing',
    title: 'Racing in Dirty Air & Close Battles',
    summary: 'How to manage the performance loss from following closely, use the slipstream effectively, and make passes when your car is actively fighting you.',
    pillar: 'racing',
    category: 'overtaking',
    difficulty: 'advanced',
    keyTakeaways: [
      'Dirty air cost at 1 car length following distance can be 30-50% downforce loss depending on the car',
      'The slipstream gives back straight-line speed but corners remain compromised — know when you\'re in and out of clean air',
      'Stay wide into the corner before an overtake to stay out of the car ahead\'s wake as long as possible',
      'Brake references shift when following closely — the car ahead disturbs your cooling and your feel changes',
      'In aero-sensitive cars, overtakes must be decisive — the longer you sit in dirty air, the more both cars suffer',
    ],
    body: `Following another car closely is one of the most technically demanding things a driver does. You're managing a car that's actively being robbed of its aerodynamic grip while simultaneously trying to outperform the car doing the robbing.\n\nThe dirty air effect is immediate and significant. Within one car length of the car ahead, you're in its turbulent wake. The underfloor venturi tunnels, which generate the bulk of modern race car downforce, stop working properly. The front wing loses efficiency. Cooling flow is compromised. What this means to you as a driver: the car that you tuned and practiced in over the weekend suddenly feels like a different animal. It understeers in corners where it was neutral. It has less braking confidence. The entry rotation that you rely on is gone.\n\nThe slipstream cuts through this. On the straight, the pocket of air behind the car ahead is lower pressure — you're being pulled forward. Your drag is reduced. This is where your speed advantage comes from. But the moment you enter the corner, that advantage reverses. Inside the corner, you need clean, organized airflow. You're not getting it.\n\nManaging a following attack: the optimal approach is to stay wide on the straight, drawing alongside the car ahead at the braking point while keeping yourself as far out of their wake as possible. A driver who drafts directly behind and then dives inside at the last moment is fighting dirty air the whole way down the straight and into the corner. A driver who moves wide early emerges from the draft in clean air, with the handling they expect.\n\nAdjusting your driving: extend your braking distance slightly when following closely. The reduced front downforce means less stopping power. Use the wider line. Err toward understeer-managing inputs rather than rotation — the rear won't rotate the way you're used to because it's also in disturbed air. Be decisive with any pass attempt. Every lap you spend behind in dirty air accelerates your tire and brake degradation.`,
    thumbnailColor: '#0A0A12',
    emoji: 'Wind',
    conceptIds: ['c-dirty-air', 'c-downforce', 'c-drag'],
    diagramIds: [],
    quizId: 'q-dirty-air-racing',
    relatedLessonIds: ['l-overtake-timing', 'l-setting-up-pass', 'l-overtake-types'],
    moduleId: 'mod-racecraft',
  ...
  {
    id: 'l-sector-optimization',
    slug: 'sector-optimization',
    title: 'Sector Optimization: Finding the Last Tenth',
    summary: 'How to systematically analyze your lap using sectors and telemetry to find time that feel-based driving leaves permanently on the table.',
    pillar: 'racing',
    category: 'sim-technique',
    difficulty: 'advanced',
    keyTakeaways: [
      'A theoretical best lap (combining best sector times) shows you the exact ceiling — and where you\'re losing',
      'Sectors rarely combine perfectly; improving one can cost another — understand the interactions',
      'Minimum speed in a corner is the single best indicator of how well that corner was driven',
      'Speed loss from a mistake compounds along the following straight — a slow apex costs more than it appears',
      'Comparison runs against a reference driver are more valuable than staring at your own times',
    ],
    body: `At some point, pushing harder doesn't find time. You're already at the limit of what feel-based driving can give you. The next layer requires a systematic, analytic approach — and that means working with sectors and telemetry as your primary feedback tool.\n\nStart with the theoretical best lap. Your timing software breaks every lap into sectors and records your best time in each sector across a session. The theoretical best is what you'd run if you combined all of those best sectors into one lap. The gap between your best actual lap and your theoretical best is the first number to understand — that's time you've proven you can run, just not simultaneously.\n\nThen look at where the gap is largest. If you're losing 0.4 seconds in sector 2 and 0.1 in sectors 1 and 3, sector 2 is your work area. Drill into that sector and identify the corners that are bleeding time. The diagnostic is minimum speed: for every corner in a problematic sector, note the speed at the apex. If your minimum speed is consistently lower than a reference driver's, you're either braking too late (reaching apex too slow), turning in too early (early apex forces lifting), or carrying too much trail brake (inducing understeer).\n\nThe sector interaction problem: improving one sector sometimes hurts the next. This happens when the exit of sector 1 feeds into the entry of sector 2. If your sector 1 best came from a setup run where you compromise the final corner for position, combining it with your best sector 2 is impossible — they're mutually exclusive. Understanding these interactions prevents chasing phantom time.\n\nComparison laps are the most powerful tool. Load a reference driver's lap alongside yours. The speed trace gap tells you exactly which corners they're faster through and by how much. Then look at the input traces: brake point, release profile, throttle pickup. Where their traces differ from yours is exactly where the time lives.`,
    thumbnailColor: '#080D12',
    emoji: 'TrendingUp',
    conceptIds: ['c-reference-points', 'c-racing-line', 'c-apex'],
    diagramIds: [],
    quizId: 'q-sector-optimization',
    relatedLessonIds: ['l-consistency', 'l-apex-types', 'l-corner-phases'],
    moduleId: 'mod-race-iq',
...

  {
    id: 'l-aero-setup',
    slug: 'aero-setup',
    title: 'Downforce vs Drag: Reading a Track for Aero',
    summary: 'How to evaluate a circuit and dial in wing angles, splitter height, and diffuser rake — and why aero setup decisions cascade through everything else.',
    pillar: 'car',
    category: 'aerodynamics',
    difficulty: 'advanced',
    keyTakeaways: [
      'Evaluate any circuit by its speed percentages: how much time at high speed vs low speed determines wing priority',
      'Every click of wing angle adds downforce and drag simultaneously — know which matters more at that circuit',
      'Front and rear aero balance matters as much as total downforce — imbalance causes handling characteristics that setups can\'t easily fix',
      'Ground effect generates higher-quality downforce (less drag per unit) than wings — protect it first',
      'Ride height and rake angle feed directly into diffuser performance — aero and suspension setup are inseparable',
    ],
    body: `Aero setup is not about finding maximum downforce. It's about finding the right balance of downforce and drag for the specific demands of a specific circuit — and then balancing the aero front-to-rear to produce the handling you want.\n\nThe starting point for any track is a speed distribution analysis. What percentage of the lap is spent above 200 km/h? What percentage under 120 km/h? A track like Monza spends most of its lap at high speed with only a handful of slow chicanes. The long straights make drag extremely costly — carrying extra downforce here costs you seconds in top speed for very little cornering benefit, because the high-speed corners don't require maximum wing anyway. Contrast with a track like Budapest: slow, tight, no meaningful straights. Here, maximum downforce is worth it because the lap time lives entirely in the corners.\n\nFront-to-rear balance is the underappreciated part of aero setup. Total downforce is one axis. Balance — the split between front and rear — is another. More front downforce relative to rear increases understeer and stability. More rear relative to front increases oversteer tendency and responsiveness. Most engineers start with a target balance percentage and then find the combination of front wing, rear wing, and undertray settings that hit that balance at the desired total load.\n\nGround effect generates downforce with dramatically less drag than wings. The diffuser and undertray running in close proximity to the road create a low-pressure zone under the car — the venturi effect. Protecting this system takes priority: ride height management, preventing bottoming out on kerbs, and maintaining consistent undertray flow all preserve the ground effect. Wing angles are the tuning knob you reach for after the ground effect is stable.`,
    thumbnailColor: '#080C15',
    emoji: 'Wind',
    conceptIds: ['c-downforce', 'c-drag', 'c-diffuser'],
    diagramIds: [],
    quizId: 'q-aero-setup',
    relatedLessonIds: ['l-ride-height', 'l-how-suspension-works'],
    moduleId: 'mod-suspension',
...

  {
    id: 'l-lsd-tuning',
    slug: 'lsd-tuning',
    title: 'LSD Tuning: Ramp Angles & Power Settings',
    summary: 'How to tune a limited-slip differential from the ground up — preload, power ramp, coast ramp, and what each setting does to the car\'s handling on corner exit.',
    pillar: 'car',
    category: 'drivetrain',
    difficulty: 'advanced',
    keyTakeaways: [
      'Preload is the baseline locking force before any torque is applied — higher preload helps rotation but hurts low-speed maneuverability',
      'Power ramp angle controls how aggressively the diff locks under acceleration — shallower angle = harder lock',
      'Coast ramp controls locking under deceleration and engine braking — often tuned independently from power ramp',
      'A locked diff on corner exit pushes wide (understeer); a looser diff allows more rotation but risks inside spin',
      'Diff tuning and throttle application technique are inseparable — the right diff for one driver style may be wrong for another',
    ],
    body: `A limited-slip differential has three primary tuning parameters: preload, power ramp angle, and coast ramp angle. Understanding each independently is the first step; understanding how they interact is the actual skill.\n\nPreload is the clamping force applied to the clutch pack before any torque input. Even at zero throttle, a high-preload diff is fighting to equalize wheel speeds. On a tight hairpin where the inside wheel needs to turn significantly slower than the outside, high preload creates resistance — the car pushes wide because the diff is preventing the natural wheel speed difference required to corner. This is oversteer-on-entry in low-speed corners, and understeer-on-corner-exit in all corners. Low preload reduces this resistance but gives up the rotational assist that preload provides on medium-speed corners where you want the car to rotate under trail braking.\n\nThe power ramp angle — the angle of the cam faces inside the diff — determines how hard the diff locks when driven wheels are transmitting torque. A shallow angle (say, 30 degrees) creates a very aggressive lock: as soon as you apply power, the diff pulls hard toward equal wheel speeds. This is good for traction on exit but pushes the car wide in power-on mid-corner situations. A steeper angle (60+ degrees) creates a softer lock — more wheelspin before lockup is reached, more rotation available, but more sensitivity to wheelspin.\n\nCoast ramp controls what happens under engine braking. A tight coast ramp creates deceleration stability — the diff resists the inside wheel spinning up under braking loads. This is helpful for cars that snap under trail braking but can create a dead, understeering feel on entry. Loose coast ramp allows the rear to rotate under braking, which combined with trail braking technique creates a very responsive entry — at the cost of stability.\n\nThe practical approach: start with a medium preload for your circuit type (higher for tight circuits, lower for flowing ones), set the power ramp to what your throttle style demands, and tune the coast ramp last based on how the car behaves on trail braking entries. Then adjust your throttle technique to match the diff — the two cannot be tuned in isolation.`,
    thumbnailColor: '#0A0F0A',
    emoji: 'Cog',
    conceptIds: ['c-lsd', 'c-oversteer', 'c-understeer', 'c-power-oversteer'],
    diagramIds: [],
    quizId: 'q-lsd-tuning',
    relatedLessonIds: ['l-how-differential-works', 'l-traction-control', 'l-drivetrain-layouts'],
    moduleId: 'mod-drivetrain',
  ...
  {
    id: 'l-brake-thermal',
    slug: 'brake-thermal-management',
    title: 'Brake Thermal Management',
    summary: 'Carbon-ceramic brake behavior, operating temperature windows, duct sizing for different circuits, and how to survive a full stint without fade.',
    pillar: 'car',
    category: 'brakes',
    difficulty: 'advanced',
    keyTakeaways: [
      'Carbon-ceramic brakes must reach 400–800°C to work properly — cold carbons have almost no stopping power',
      'A cold lap without brake prep on carbon discs can be genuinely dangerous — the brakes feel wooden and distant',
      'Duct opening size is the primary thermal management tool — teams tune it per circuit, not per session',
      'Over-cooled brakes are as dangerous as overheated ones — keeping them in the window is the goal in both directions',
      'Brake bias shifts across a stint as pad material transfers to the disc — monitor and adjust, not just once',
    ],
    body: `Carbon-ceramic brake systems — used on all top-level race cars and available on high-performance road cars — have fundamentally different operating characteristics than the cast-iron systems most drivers are familiar with. Understanding this difference is not optional for anyone driving cars equipped with them.\n\nThe critical fact: carbon brakes require heat to work. A carbon disc below its operating temperature (roughly 400°C minimum, with optimal range 500–800°C depending on compound) generates very little friction. The pedal feels wooden, travel is long, and stopping power is dramatically reduced. This is why race cars perform brake warming laps on the out lap, and why drivers weave to generate heat before the green flag. It's also why a safety car period followed immediately by a restart is genuinely risky — the brakes may have cooled below their working range during the slow laps.\n\nOverheating carbons is equally problematic. Above their optimal range, the compounds begin to oxidize and the pad surface material transfers unevenly. You get brake judder — the disc warps or develops high spots — and the friction coefficient drops. Unlike iron brakes, which show overheating progressively, carbon brakes can fall off a cliff fairly quickly above their ceiling temperature.\n\nDuct sizing is the primary weapon. Engineers calculate the duct opening based on how much energy the brakes need to absorb per lap divided by how much cooling time is available (the straights). Monza, with its three hard stops per lap and six long straights, needs small ducts — brakes load up briefly and have plenty of time to cool. Monaco, with brakes loading up constantly and very little straight-line recovery, needs large ducts. Getting this wrong at Monaco can mean complete brake failure by lap 15.\n\nPad material transfers during use. As the brake warms and the pads work against the disc, material transfers from pad to disc surface. This changes the friction characteristics over the race. Brake bias that was correct in qualifying may be slightly too rear-biased by lap 30 as the front pads develop a transfer layer. Monitoring this and adjusting bias as needed is part of in-race management, not just a setup task.`,
    thumbnailColor: '#150A08',
    emoji: 'Disc',
    conceptIds: ['c-brake-bias', 'c-brake-duct'],
    diagramIds: ['d-brake-system'],
    quizId: 'q-brake-thermal',
    relatedLessonIds: ['l-how-brakes-work', 'l-brake-bias-tuning', 'l-brake-fade'],
    moduleId: 'mod-brakes',
  ...
  {
    id: 'l-turbo-power-delivery',
    slug: 'turbo-power-delivery',
    title: 'Turbo Power Delivery & Driving Technique',
    summary: 'How turbocharged power delivery differs from naturally aspirated, what turbo lag demands from driving technique, and how to use boost as a strategic tool.',
    pillar: 'car',
    category: 'engine',
    difficulty: 'advanced',
    keyTakeaways: [
      'Turbo lag creates a time delay between throttle input and torque delivery — throttle timing changes completely',
      'In low-speed corners, get on throttle earlier than in an NA car to account for spool time',
      'Lifting off completely resets boost pressure — in turbo cars, you manage throttle to maintain boost more than in NA cars',
      'Wastegate rattle (surge) at partial throttle can cause sudden power drops — throttle position must be decisive',
      'Modern hybrid turbo systems dramatically reduce lag but the principle of managing boost pressure still applies',
    ],
    body: `Driving a turbocharged race car is not the same as driving a naturally aspirated one. The power delivery characteristics are different in ways that demand specific technique adjustments — and drivers who don't adapt leave significant performance on the table and risk mechanical damage from mismanaging boost.\n\nThe defining characteristic of turbo power delivery is the relationship between throttle application and actual power output. In an NA engine, throttle position maps fairly directly to power — open the throttle and power arrives almost immediately (within the inertia limits of the drivetrain). In a turbocharged engine, the turbocharger needs exhaust gas to spool up. At low RPM with low exhaust flow, the turbo provides little boost. As RPM rises and exhaust flow increases, boost builds and power delivery becomes aggressive — often dramatically so.\n\nThe implication for corner exit technique: in a turbo car, you need to apply throttle earlier in the corner than in an NA car to account for the spool time. If you wait until the apex to get on throttle the way you would in an NA car, the power won't arrive until you're already halfway down the exit. You're late on power, compromising exit speed. The early throttle in a turbo car isn't about getting more power — it's about requesting power early enough that it arrives when you need it.\n\nThe lift-off behavior is also different. In an NA car, lifting fully off the throttle is straightforward — you lose the engine's power contribution and gravity/drag slows you. In a turbo car, lifting fully off dumps boost pressure entirely. When you get back on throttle, you're waiting for spool from scratch. Skilled turbo drivers learn to maintain a tiny amount of throttle through sections where an NA driver would lift completely — keeping the turbo spinning at low pressure so that when full power is requested, the spool time is minimal.\n\nCompressor surge is a failure mode specific to turbos: at low RPM and partial throttle, the compressor can enter an unstable pressure range and begin oscillating. You hear this as a flutter or rattle from the intake. It's inefficient and stresses the compressor. The solution is to either be decisively on throttle or decisively off — avoid holding partial throttle at low RPM where surge occurs.`,
    thumbnailColor: '#100A08',
    emoji: 'Zap',
    conceptIds: ['c-turbocharger'],
    diagramIds: [],
    quizId: 'q-turbo-power-delivery',
    relatedLessonIds: ['l-torque-vs-hp', 'l-traction-control', 'l-engine-braking'],
    moduleId: 'mod-drivetrain',
  ...
  {
    id: 'l-setup-philosophy',
    slug: 'setup-philosophy',
    title: 'Building a Setup: Where to Start',
    summary: 'A systematic approach to building a car setup from scratch — the priority order, the diagnostic process, and how to avoid chasing your tail through random changes.',
    pillar: 'car',
    category: 'setup',
    difficulty: 'advanced',
    keyTakeaways: [
      'Always establish a baseline before changing anything — you need something to compare against',
      'Change one thing at a time; multiple simultaneous changes make it impossible to know what helped',
      'Geometry (ride height, camber, toe) first, then mechanical grip (springs, ARBs), then aero, then fine-tuning',
      'The car should understeer slightly on entry and be neutral to mild oversteer on exit — start from this target',
      'Describe handling problems in corner phase and location: entry/mid/exit, slow/medium/fast — this guides the fix',
    ],
    body: `Setting up a race car is a systematic process, not a random walk through the settings menu. The drivers and engineers who work through it methodically consistently outperform those who make intuitive changes and hope. Here's the framework.\n\nBefore changing anything, establish a real baseline. This means going out on a stock or default setup and running enough laps to build a clear picture of what the car is doing. Document the handling characteristics: where does it push? Where does it rotate? What does it do at corner entry vs exit vs mid-corner? You need clear problem statements before you can apply solutions. "The car feels off" is not a problem statement. "The car understeers on exit of medium-speed corners" is.\n\nWork through the setup in a priority order: geometry first, then mechanical grip, then aerodynamics, then fine adjustments. This order matters because lower layers affect the behavior of everything above them. Changing your ride height changes your aero balance — if you tune the wing first, you'll have to retune it after changing the ride height anyway. Geometry establishes the platform. Springs and dampers control how the car moves on that platform. Aero loads that platform and manages balance at speed. Fine adjustments (brake bias, differential, traction control maps) are optimized last.\n\nWhen you identify a handling problem, locate it in three dimensions: which end of the car (front or rear), which phase of the corner (entry, mid-corner, exit), and what speed category (slow, medium, fast). This triple-location tells you what's causing it and what to change. Entry understeer in slow corners is usually about front mechanical grip and diff coast settings. Exit oversteer in fast corners is usually about rear suspension compliance and aero balance at speed. These are different problems requiring different solutions — but drivers who just say "the car handles badly" can't diagnose them.\n\nChange one thing at a time. This is the discipline that separates effective setup work from random noise. If you change the front spring rate and the rear toe and the brake bias in the same run, you can't know what helped, what hurt, or what cancelled out. One change, clear feedback, decision, next change. It feels slower but it's faster — because you end up at the right answer instead of orbiting around it.`,
    thumbnailColor: '#0C0C0F',
    emoji: 'Settings2',
    conceptIds: ['c-spring-rate', 'c-damper', 'c-contact-patch', 'c-downforce'],
    diagramIds: [],
    quizId: 'q-setup-philosophy',
    relatedLessonIds: ['l-ride-height', 'l-spring-rates', 'l-damper-tuning', 'l-anti-roll-bars'],
    moduleId: 'mod-suspension',
...
export const MOCK_MODULES: Module[] = [
  ...
  },
  {
    ...
    lessonIds: [
      ...
      'l-consistency',
      'l-beginner-mistakes',
      'l-tire-management-racing',
      'l-sector-optimization',
    ],
    emoji: 'Brain',
    color: '#4A9EDB',
  },
...
export const MOCK_QUIZZES: Quiz[] = [
  ...
  {
    id: 'q-trail-braking-advanced',
    lessonId: 'l-trail-braking-advanced',
    title: 'Trail Braking at the Limit Quiz',
    questions: [
      {
        id: 'qtba-1',
        question: 'How should brake pressure decrease from the turn-in point to the apex?',
        options: [
          'Linearly — equal reduction per meter of arc',
          'Exponentially — steep drop initially, barely-perceptible trace near the apex',
          'In one clean step at the mid-corner point',
          'It should reach zero before the apex in all cases',
        ],
        correctIndex: 1,
        explanation: 'Most of the deceleration happens before turn-in. From turn-in to apex, the release is exponential: fast initially then slowing to almost nothing near the apex, keeping just enough pressure to load the fronts through the entry arc.',
      },
      {
        id: 'qtba-2',
        question: 'What specific additional function does trail braking serve at high-speed corners that it doesn\'t in slow ones?',
        options: [
          'It prevents understeer by loading the rear',
          'It stabilizes the car by keeping the nose loaded against aero lift',
          'It reduces lap time by shortening the braking distance',
          'It allows the driver to steer with throttle rather than the wheel',
        ],
        correctIndex: 1,
        explanation: 'At high-speed corners, a complete brake release before turn-in allows the nose to rise as weight shifts rearward, reducing front downforce just when it\'s needed most. Holding a trace of brake prevents this transition and keeps the front planted.',
      },
      {
        id: 'qtba-3',
        question: 'On a telemetry trace, what does correct trail braking look like when brake pressure and steering angle are overlaid?',
        options: [
          'Brake pressure and steering angle are both high simultaneously through the whole corner entry',
          'Brake pressure drops to zero, then steering angle rises from zero — they never overlap',
          'Brake pressure decreases smoothly as steering angle increases, the traces converging near the apex',
          'Brake pressure increases as steering angle increases to prevent understeer',
        ],
        correctIndex: 2,
        explanation: 'Correct trail braking shows the brake trace declining smoothly as the steering trace rises — they converge somewhere near the apex. Abrupt brake end while steering is still rising means releasing too early. Parallel traces mean too much brake held for too long.',
      },
    ],
  },
  {
    id: 'q-corner-linking',
    lessonId: 'l-corner-linking',
    title: 'Linking Corners Quiz',
    questions: [
      {
        id: 'qcl-1',
        question: 'What primarily determines the "value" of a corner in a lap?',
        options: [
          'The speed of the corner itself',
          'What comes after the corner — especially whether it leads onto a long straight',
          'How technical the corner entry is',
          'The corner\'s position in the lap (early vs late)',
        ],
        correctIndex: 1,
        explanation: 'A corner\'s value is determined by what follows it. A corner feeding onto a long straight is extremely valuable because exit speed compounds over the entire straight. A corner feeding into another corner or a slow section has much less value.',
      },
      {
        id: 'qcl-2',
        question: 'In a chicane (two corners in sequence), which element should be the priority for optimization?',
        options: [
          'The first element — it sets up everything that follows',
          'The second element — it determines the exit speed onto the following section',
          'Both equally — each corner should be driven at the individual optimum',
          'Neither — chicanes should be driven at constant speed throughout',
        ],
        correctIndex: 1,
        explanation: 'The second element of a chicane is the priority because it sets the exit speed onto whatever follows. The first element is navigated to arrive in the best position for the second — even if that means a slightly compromised line through it.',
      },
      {
        id: 'qcl-3',
        question: 'When deliberately compromising a setup corner, what is the key mental commitment required?',
        options: [
          'Accepting that overall lap time will be worse',
          'Committing fully to the planned line — hesitation gives the worst of both corners',
          'Maintaining the same throttle position as in an individually-optimized corner',
          'Entering the setup corner on the opposite line to normal',
        ],
        correctIndex: 1,
        explanation: 'Deliberately entering a corner sub-optimally only works if you fully commit to the plan. If you hesitate mid-plan, you\'ll be on a compromised line for the setup corner and not arriving correctly for the priority corner — giving you the worst of both approaches.',
      },
    ],
  },
  {
    id: 'q-tire-management-racing',
    lessonId: 'l-tire-management-racing',
    title: 'Tire Management Quiz',
    questions: [
      {
        id: 'qtmr-1',
        question: 'What is the key difference between thermal tire degradation and wear?',
        options: [
          'Thermal degradation only affects rear tires; wear affects all four',
          'Thermal degradation can partially recover with reduced driving intensity; wear cannot be undone',
          'Wear reduces grip immediately; thermal degradation only affects tire life, not performance',
          'They are the same thing described from different perspectives',
        ],
        correctIndex: 1,
        explanation: 'Wear is physical rubber loss — permanent and irreversible within a stint. Thermal degradation is heat damage that, in early stages, may partially recover if you reduce driving intensity and allow the tire to cool back into its operating window.',
      },
      {
        id: 'qtmr-2',
        question: 'What is usually the first sign that rear tires are significantly degraded during a stint?',
        options: [
          'Increased straight-line speed due to less tire resistance',
          'The car begins to oversteer violently on every corner exit',
          'The car loses its willingness to rotate on corner entry — it starts pushing where it used to rotate',
          'Tire pressure increases noticeably on the dashboard',
        ],
        correctIndex: 2,
        explanation: 'The rear tires contribute to corner entry rotation through their grip. As they degrade, they lose the ability to participate in that rotation — the car starts to understeer on entry where it was previously neutral. This is usually the first sign of rear degradation.',
      },
      {
        id: 'qtmr-3',
        question: 'What is the main driving behavior that accelerates tire degradation most?',
        options: [
          'High corner entry speed',
          'Sliding — both understeer and oversteer scrub rubber and generate heat simultaneously',
          'Late braking into slow corners',
          'Aggressive downshifting with engine braking',
        ],
        correctIndex: 1,
        explanation: 'Sliding is the primary killer. Every slide removes rubber from the contact patch surface and generates heat simultaneously — two forms of damage with one input. The driver who saves tires generates the same cornering forces with less sliding through smoother inputs and better line choice.',
      },
    ],
  },
  {
    id: 'q-dirty-air-racing',
    lessonId: 'l-dirty-air-racing',
    title: 'Dirty Air & Close Racing Quiz',
    questions: [
      {
        id: 'qdar-1',
        question: 'What happens to a car\'s handling when following closely in another car\'s wake?',
        options: [
          'Braking improves because the draft reduces speed requiring less braking force',
          'The car gains understeer and reduced braking confidence due to downforce loss',
          'The car gains oversteer because the rear loses more downforce than the front',
          'Handling is unaffected — only straight-line speed changes in dirty air',
        ],
        correctIndex: 1,
        explanation: 'In dirty air, the turbulent wake disrupts the organized airflow that generates downforce. The underfloor venturi, front wing, and rear wing all lose efficiency, resulting in understeer and reduced braking confidence — the car feels like a different, slower version of itself.',
      },
      {
        id: 'qdar-2',
        question: 'What is the optimal positioning strategy when preparing an overtake on a straight?',
        options: [
          'Tuck directly behind the car ahead to maximize slipstream effect all the way to the braking zone',
          'Move wide on the straight to exit the car\'s wake and arrive at the braking zone in clean air',
          'Stay behind until the last possible moment to disguise your overtake intention',
          'Drive on the opposite side of the straight from the car ahead regardless of corner direction',
        ],
        correctIndex: 1,
        explanation: 'Moving wide on the straight brings you out of the car\'s turbulent wake while still benefiting from some slipstream on straight-line speed. You arrive at the braking zone in cleaner air with the handling you expect — rather than fighting compromised aerodynamics at the most critical moment.',
      },
      {
        id: 'qdar-3',
        question: 'Why should following drivers extend their braking distance slightly when in dirty air?',
        options: [
          'The slipstream increases their speed, so they\'re carrying more momentum',
          'Reduced front downforce means less aerodynamic contribution to stopping power',
          'The car ahead will be braking later, requiring the following driver to brake later too',
          'Tire temperatures are lower in dirty air, reducing grip',
        ],
        correctIndex: 1,
        explanation: 'Front downforce contributes to braking stability and helps load the front tires under deceleration. In dirty air, with reduced front downforce, the braking capability is genuinely reduced — using the same braking references will result in running deep and missing the apex.',
      },
    ],
  },
  {
    id: 'q-sector-optimization',
    lessonId: 'l-sector-optimization',
    title: 'Sector Optimization Quiz',
    questions: [
      {
        id: 'qso-1',
        question: 'What does the "theoretical best lap" represent?',
        options: [
          'The lap time a perfect driver could achieve with the car at maximum potential',
          'Your best time in each individual sector combined into one lap',
          'The lap time predicted by simulation software',
          'The fastest recorded lap on that circuit across all drivers',
        ],
        correctIndex: 1,
        explanation: 'The theoretical best lap combines your personal best time from each individual sector into a single number. It represents the ceiling of what you\'ve already proven you can do — just not simultaneously — and the gap between it and your best actual lap shows available time.',
      },
      {
        id: 'qso-2',
        question: 'What is the most useful single data point for evaluating how well a specific corner was driven?',
        options: [
          'Entry speed at the braking point',
          'Time spent in the corner from turn-in to exit',
          'Minimum speed at the apex',
          'Throttle position at the corner exit',
        ],
        correctIndex: 2,
        explanation: 'Minimum speed in the corner (usually at or near the apex) is the best single indicator of corner performance. A low minimum speed means you either over-slowed on entry or had to lift through the corner. Higher minimum speed at the apex directly translates to faster exit and more speed on the following straight.',
      },
      {
        id: 'qso-3',
        question: 'Why is it important to understand that best sector times may not be combinable?',
        options: [
          'Timing systems can have measurement errors between sectors',
          'A best sector 1 time may have used a setup compromise that makes sector 2\'s best impossible from that position',
          'Sectors overlap and the same lap moment may be counted in both',
          'Weather conditions change between sector attempts',
        ],
        correctIndex: 1,
        explanation: 'Best sector times are often recorded in laps with different strategic approaches. Your best sector 1 may end in a position or attitude that makes your sector 2 best impossible. Understanding these interactions prevents chasing phantom time by treating the theoretical best as a simple sum of achievable parts.',
      },
    ],
  },
  {
    id: 'q-aero-setup',
    lessonId: 'l-aero-setup',
    title: 'Aero Setup Quiz',
    questions: [
      {
        id: 'qas-1',
        question: 'What is the first evaluation to make when approaching aero setup for a new circuit?',
        options: [
          'Measure the track\'s minimum corner radius to determine required downforce',
          'Check the wind direction for the qualifying session',
          'Analyze the speed distribution — how much lap time is spent at high speed versus low speed',
          'Find the lowest possible ride height to maximize ground effect',
        ],
        correctIndex: 2,
        explanation: 'Speed distribution determines whether downforce or drag reduction is more valuable. A track with most time at high speed (Monza) prioritizes drag reduction — downforce from wings costs too much in straight-line speed. A slow, technical track (Monaco) justifies maximum downforce because the lap is all corners.',
      },
      {
        id: 'qas-2',
        question: 'What does front aero downforce that is disproportionately high relative to rear produce?',
        options: [
          'Oversteer — the rear has less grip than the front due to less downforce',
          'Understeer — too much load on the fronts relative to rears creates push',
          'Better traction out of corners due to balanced weight distribution',
          'Snap oversteer because the rear is unloaded',
        ],
        correctIndex: 1,
        explanation: 'More front downforce than rear pushes the front of the car harder into the road than the rear. Cornering forces available at the front are higher than at the rear — the fronts can handle more lateral load. This imbalance means the car understeers: the rear reaches its limit before the front does.',
      },
      {
        id: 'qas-3',
        question: 'Why is managing ground effect downforce the higher priority than tuning wing angles?',
        options: [
          'Wing angles are fixed by regulations at most circuits',
          'Ground effect generates more downforce per unit of drag than wings — protecting it is more efficient',
          'Wing angles affect the car\'s aesthetics more than performance',
          'Ground effect only matters in the wet',
        ],
        correctIndex: 1,
        explanation: 'Ground effect creates large amounts of downforce with comparatively little drag — a much better downforce-to-drag ratio than wing devices. Keeping the underbody in clean, consistent flow (through correct ride height and preventing bottoming) preserves this highly efficient downforce source first. Wings are the adjustment dial afterward.',
      },
    ],
  },
  {
    id: 'q-lsd-tuning',
    lessonId: 'l-lsd-tuning',
    title: 'LSD Tuning Quiz',
    questions: [
      {
        id: 'qlt-1',
        question: 'What does high LSD preload cause in tight, low-speed corners?',
        options: [
          'Oversteer — the rear rotates more aggressively',
          'Understeer — the diff resists the natural wheel speed difference needed to turn',
          'Snap oversteer on corner exit due to sudden lock engagement',
          'No effect — preload only matters at high throttle inputs',
        ],
        correctIndex: 1,
        explanation: 'In a tight corner, the inside wheel must turn significantly slower than the outside. High preload resists this natural difference, preventing the car from rotating as freely as it needs to. The result is understeer — the car pushes wide because the diff is fighting the corner geometry.',
      },
      {
        id: 'qlt-2',
        question: 'A shallow power ramp angle in an LSD creates what effect on corner exit?',
        options: [
          'Earlier wheelspin and more oversteer',
          'More aggressive locking under acceleration — better traction but tendency to push wide on power',
          'Less effective torque transmission to the outside wheel',
          'The diff becomes inactive and behaves like an open differential',
        ],
        correctIndex: 1,
        explanation: 'A shallow ramp angle creates aggressive locking — as soon as torque is applied, the diff pulls hard toward equal wheel speeds. This improves traction but under hard power mid-corner, it prevents the natural speed difference needed to turn, pushing the car wide. Good for traction, costs rotation.',
      },
      {
        id: 'qlt-3',
        question: 'Why must diff tuning and driving technique be adjusted together rather than independently?',
        options: [
          'Software limitations prevent them from being changed separately',
          'The diff\'s behavior directly determines what throttle application technique works — the two cannot be optimized in isolation',
          'Regulatory rules require matching documentation for both',
          'Diff settings automatically adjust to compensate for driving style',
        ],
        correctIndex: 1,
        explanation: 'A tightly-tuned diff for one driving style (smooth, early throttle, minimum rotation) can be undriveable for another style (late throttle, high rotation). The diff setting shapes what happens when throttle is applied mid-corner, and the driver\'s throttle technique shapes what loads reach the diff. The interaction is direct and unavoidable.',
      },
    ],
  },
  {
    id: 'q-brake-thermal',
    lessonId: 'l-brake-thermal',
    title: 'Brake Thermal Management Quiz',
    questions: [
      {
        id: 'qbt-1',
        question: 'What is the minimum operating temperature for carbon-ceramic brakes to function properly?',
        options: [
          'Around 100°C — just above water boiling point',
          'Around 400°C — well above anything cast-iron brakes require',
          'Room temperature — carbon brakes are effective from cold',
          'Around 200°C — similar to iron brakes at working temperature',
        ],
        correctIndex: 1,
        explanation: 'Carbon-ceramic brakes need to reach roughly 400°C minimum before they generate meaningful friction — with the optimal range typically 500–800°C. A cold carbon disc feels wooden and distant, with dramatically reduced stopping power compared to warmed-up carbons.',
      },
      {
        id: 'qbt-2',
        question: 'Why might a driver need large brake ducts at Monaco but small ones at Monza?',
        options: [
          'Monaco is hotter than Monza and heat naturally transfers to the brakes',
          'Monaco\'s constant braking with little recovery time requires more cooling; Monza\'s few stops and long straights allow natural cooling',
          'Monaco regulations require larger ducts for safety',
          'Monza\'s high-speed braking generates less heat than Monaco\'s low-speed braking',
        ],
        correctIndex: 1,
        explanation: 'At Monaco, the brakes load up constantly with almost no straight-line time to cool — without large ducts, cumulative heat would cause fade and failure. Monza has only a few hard braking zones and six long straights where brakes cool naturally — large ducts here would over-cool the brakes below their operating window.',
      },
      {
        id: 'qbt-3',
        question: 'Why does brake bias sometimes need to be adjusted during a race, not just during setup?',
        options: [
          'Tire wear changes the weight distribution of the car significantly',
          'Pad material transfers to the disc surface during use, changing friction characteristics over the race',
          'The brake cooling ducts become clogged with debris, requiring bias compensation',
          'Fuel load decreases make the car lighter at the front, requiring less front brake',
        ],
        correctIndex: 1,
        explanation: 'As pads wear against the discs, material transfers from pad surface to disc surface — this is a normal part of brake operation. This transfer layer changes the friction coefficient over time, meaning the brake behavior at a fixed bias setting drifts as the race progresses. Monitoring and adjusting bias in-race accounts for this.',
      },
    ],
  },
  {
    id: 'q-turbo-power-delivery',
    lessonId: 'l-turbo-power-delivery',
    title: 'Turbo Power Delivery Quiz',
    questions: [
      {
        id: 'qtpd-1',
        question: 'Why do turbo cars require throttle application earlier in a corner compared to NA cars?',
        options: [
          'Turbo cars are heavier and need more time to reach corner exit speed',
          'The turbo needs time to spool up — applying throttle earlier means power arrives when actually needed at the exit',
          'Earlier throttle prevents oversteer by pre-loading the rear tires',
          'Turbo cars have lower peak power and need the full exit to develop speed',
        ],
        correctIndex: 1,
        explanation: 'Turbo lag means there is a delay between throttle input and boost arriving. In an NA car, applying throttle at the apex produces power immediately at the apex. In a turbo car, applying throttle at the apex produces power later — after the exit. Applying throttle earlier compensates for this delay so power arrives when you need it.',
      },
      {
        id: 'qtpd-2',
        question: 'Why do skilled turbo drivers sometimes maintain partial throttle through sections where they would lift completely in an NA car?',
        options: [
          'To keep the car more stable under deceleration',
          'To keep the turbo spinning so boost pressure doesn\'t drop to zero, reducing spool time when full throttle is needed',
          'Turbo engines cannot handle complete throttle lifts safely',
          'Partial throttle in turbo cars activates regenerative braking',
        ],
        correctIndex: 1,
        explanation: 'A full throttle lift in a turbo car dumps boost pressure entirely — the turbo stops receiving exhaust energy and slows. When you then demand full power, spool time starts from scratch. Maintaining a tiny amount of throttle keeps the turbo spinning at low pressure, so when you want full power, spool time is minimal.',
      },
      {
        id: 'qtpd-3',
        question: 'What is compressor surge and how is it avoided?',
        options: [
          'Overboost at high RPM — avoided by lifting the throttle briefly above 7000 RPM',
          'Compressor instability at low RPM and partial throttle causing flutter — avoided by being decisively on or off throttle',
          'Boost pressure drop under heavy braking — avoided by left-foot braking',
          'Wastegate rattle at high boost — avoided by running lower boost maps',
        ],
        correctIndex: 1,
        explanation: 'Compressor surge occurs at low RPM and partial throttle where the compressor enters an unstable pressure range and begins oscillating — you hear it as flutter or rattle. The fix is to avoid the partial-throttle low-RPM zone by being decisive: fully on throttle or fully off, with no hesitation in between.',
      },
    ],
  },
  {
    id: 'q-setup-philosophy',
    lessonId: 'l-setup-philosophy',
    title: 'Setup Philosophy Quiz',
    questions: [
      {
        id: 'qsp-1',
        question: 'What is the correct priority order for working through a race car setup?',
        options: [
          'Aero → springs/dampers → geometry → fine adjustments',
          'Geometry → mechanical grip (springs/ARBs) → aero → fine adjustments',
          'Fine adjustments first to find the quickest win, then bigger changes',
          'Dampers → ride height → wing angles → springs',
        ],
        correctIndex: 1,
        explanation: 'Geometry establishes the platform — changing it later forces everything else to be retuned. Springs and dampers control movement on that platform. Aero loads the platform and is affected by geometry (ride height, rake). Fine adjustments (diff, bias, TC) are last because they depend on having the car fundamentally balanced first.',
      },
      {
        id: 'qsp-2',
        question: 'A driver says "the car handles badly on medium-speed entries." Why is this an insufficient problem description for setup work?',
        options: [
          'It is sufficient — it correctly identifies the circuit type as medium-speed',
          'It doesn\'t specify which end of the car is problematic, preventing an accurate diagnosis of cause and solution',
          'Setup cannot address entry handling — only driving technique can',
          'Medium-speed is not a defined category in setup terminology',
        ],
        correctIndex: 1,
        explanation: 'Effective setup diagnosis requires knowing the end of the car (front or rear), the corner phase (entry/mid/exit), and the speed category. "Handles badly on entry" could mean front understeer, rear-led rotation, or snap oversteer — three completely different problems with different solutions. Without locating the problem precisely, you\'re guessing.',
      },
      {
        id: 'qsp-3',
        question: 'Why is the "change one thing at a time" discipline so important in setup work?',
        options: [
          'Racing regulations limit how many setup changes can be made per session',
          'Multiple simultaneous changes make it impossible to identify what helped, what hurt, or what cancelled out',
          'The car\'s ECU can only process one setting change at a time',
          'Changing multiple things simultaneously causes mechanical damage',
        ],
        correctIndex: 1,
        explanation: 'When multiple changes are made simultaneously, you lose the ability to attribute the outcome to any specific change. If the car gets faster, which change helped? If it gets worse, which hurt? You\'ve added noise to your data instead of signal. One change, clear feedback, decision — then the next change.',
      },
    ],
  },
  {
